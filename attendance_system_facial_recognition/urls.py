     ...
     path('mark_your_attendance', recog_views.mark_your_attendance ,name='mark-your-attendance'),
      ...
      path('view_attendance_home', recog_views.view_attendance_home ,name='view-attendance-home'),
       ...
       path('not_authorised', recog_views.not_authorised, name='not-authorised'),
        path('stop_stream_out/', recog_views.stop_stream_out, name='stop_stream_out'),
        path('toggle_stream_out/', recog_views.toggle_stream_out, name='toggle_stream_out'),
        path('stop_stream_in/', recog_views.stop_stream_in, name='stop_stream_in'),
        path('toggle_stream_in/', recog_views.toggle_stream_in, name='toggle_stream_in'),
